...
public final class Constants {
  ...
  public static class EndEffectorConstants {
    public static final double kEndEffectorOnSpeed = 0.3;
    public static final double kEndEffectorReverseSpeed = -0.3;
    public static final int EndEffectorMotorID = 24;
  }
}
